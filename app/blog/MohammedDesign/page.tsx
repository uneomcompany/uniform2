...
export const metadata: Metadata = {
  title: 'Modern Uniform Design Principles for Corporate Identity | Uniform Supplier in KSA',
  ...
  openGraph: {
    ...
    description: 'Discover how modern uniform design can enhance your corporate identity and brand recognition in the Saudi market.',
    type: 'article',
    publishedTime: '2023-10-18T08:00:00Z',
    authors: ['Uniform KSA']
  }
};
  ...
  return (
    ...
    >
      <div className="prose max-w-none">
        <p className="lead">
          Discover how modern uniform design can enhance your corporate identity and brand recognition in the Saudi market.
        </p>
        
        <figure className="my-8">
          <StaticImageFix
            src="/images/blog/blog_hero.jpg"
            alt="Modern Uniform Design Principles for Corporate Identity"
            width={800}
            height={400}
      ...
      <div className="mt-12 border-t border-gray-200 pt-8">
        <AuthorInfo author="محمد_الغامدي" />
      </div>

      <div className="mt-8">
        <ShareButtons title="Modern Uniform Design Principles for Corporate Identity" />
      </div>

      <div className="mt-12">
        <RelatedPosts currentSlug="MohammedDesign" category="Design" />
      </div>
