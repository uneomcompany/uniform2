...
export const metadata: Metadata = {
  title: 'Industrial Workwear Safety Standards in Saudi Manufacturing | Uniform Supplier in KSA',
  description: 'A comprehensive guide to industrial workwear safety standards for manufacturing facilities in Saudi Arabia.',
  openGraph: {
    title: 'Industrial Workwear Safety Standards in Saudi Manufacturing | Uniform Supplier in KSA',
    description: 'A comprehensive guide to industrial workwear safety standards for manufacturing facilities in Saudi Arabia.',
    type: 'article',
    publishedTime: '2024-01-25T08:00:00Z',
    authors: ['Uniform KSA']
  }
};
  ...
  return (
    ...
    >
      <div className="prose max-w-none">
        <p className="lead">
          A comprehensive guide to industrial workwear safety standards for manufacturing facilities in Saudi Arabia.
        </p>
        
        <figure className="my-8">
          <StaticImageFix
            src="/images/blog/blog_hero.jpg"
            alt="Industrial Workwear Safety Standards in Saudi Manufacturing"
            width={800}
            height={400}
      ...
      <div className="mt-12 border-t border-gray-200 pt-8">
        <AuthorInfo author="محمد_السعيد" />
      </div>

      <div className="mt-8">
        <ShareButtons title="Industrial Workwear Safety Standards in Saudi Manufacturing" />
      </div>

      <div className="mt-12">
        <RelatedPosts currentSlug="mohammed-al-otaibi" category="Industrial" />
      </div>
