...
export const metadata: Metadata = {
  title: 'Best Materials for Transport Sector Uniforms in Saudi Arabia | Uniform Supplier in KSA',
  ...
  openGraph: {
    ...
    description: 'Analysis of the most suitable materials for transport sector uniforms considering Saudi Arabia's climate and working conditions.',
    type: 'article',
    publishedTime: '2024-02-10T08:00:00Z',
    authors: ['Uniform KSA']
  }
};
  ...
  return (
    ...
    >
      ...
      <div className="mt-12 border-t border-gray-200 pt-8">
        <AuthorInfo author="عبدالله_الخالدي" />
      </div>
      ...
      <div className="mt-12">
        <RelatedPosts currentSlug="transport-uniform-materials" category="Transport" />
      </div>
