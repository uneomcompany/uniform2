...
export const metadata: Metadata = {
  title: 'Retail Uniform Trends Shaping Saudi Arabia's Customer Experience | Uniform Supplier in KSA',
  ...
  openGraph: {
    ...
    description: 'Explore how retail uniform trends are evolving to enhance customer experience in Saudi Arabia's competitive retail landscape.',
    type: 'article',
    publishedTime: '2023-09-30T08:00:00Z',
    authors: ['Uniform KSA']
  }
};
  ...
  return (
    ...
    >
      <div className="prose max-w-none">
        <p className="lead">
          Explore how retail uniform trends are evolving to enhance customer experience in Saudi Arabia's competitive retail landscape.
        </p>
        
        <figure className="my-8">
          <StaticImageFix
            src="/images/blog/blog_hero.jpg"
            alt="Retail Uniform Trends Shaping Saudi Arabia's Customer Experience"
            width={800}
            height={400}
      ...
      <div className="mt-8">
        <ShareButtons title="Retail Uniform Trends Shaping Saudi Arabia's Customer Experience" />
      </div>

      <div className="mt-12">
        <RelatedPosts currentSlug="SaraRetailKSA" category="Retail" />
      </div>
