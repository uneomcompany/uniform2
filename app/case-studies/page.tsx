...
const caseStudies = [
  {
    ...
    image: "/images/aramco_case_study.jpg",
    industry: "Oil & Gas",
  ...
  },
  {
    ...
    image: "/images/neom_case_study.jpg",
  ...
  },
  {
    ...
    image: "/images/hospital_case_study.jpg",
    industry: "Healthcare",
  ...
  },
  {
    ...
    image: "/images/school_case_study.jpg",
    industry: "Education",
            ...
            <Link href={`/blog/case-studies/${study.slug}`}>
              <div className="md:flex">
                <div className="md:w-1/3 relative h-64 md:h-auto">
                  <Image
                    src={study.image || '/images/placeholder.jpg'}
                    alt={study.title}
                    fill
